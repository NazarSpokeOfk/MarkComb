          ...
          <div className="terms__container">
            ...
            <p className="terms__defenition none">
              <Trans i18nKey="first-answer">
                ...
                famous platform “YouTube” Our service will save time and money
                for people who want to buy advertising from bloggers
              </Trans>
            </p>
            ...
            <p className="terms__defenition none">
              <Trans i18nKey="Fourth-answer">
                Yes, previously purchased data will be stored on your account,
                but it is also worth considering that the contentmaker may
                change their contact details and they may not be up to date. In
                such situations, no refunds are available. And it is also worth
                considering that the contentmaker may stop his activity, and in
                order to optimize the work of the service, the contact details
                of the contentmaker who is no longer engaged in his activity
                will be deleted.
              </Trans>
            </p>
          </div>
