          ...
          <div className="terms__container">
            ...
            <p className="terms__defenition none">
              ...
              <Trans i18nKey="1.01">
                ...
                describes how MarkComb (hereinafter referred to as the
                "Service") collects, processes, stores, and protects personal
                data of users.
              </Trans>
            </p>
            ...
            <p className="terms__defenition none">
              <span>1.3</span> -{" "}
              <Trans i18nKey="1.03">
                By using the Service, the User agrees to the terms of this
                Policy and gives explicit consent to the processing of their
                personal data.
              </Trans>
            </p>
            ...
            <p className="terms__defenition none">
              <span>1.4</span> -{" "}
              <Trans i18nKey="1.04">
                This Policy is developed in accordance with the Federal Law No.
                152-FZ of July 27, 2006 “On Personal Data” and other regulatory
                acts of the Russian Federation in the field of personal data
                protection.
              </Trans>
            </p>
            ...
            <p className="terms__defenition none">
              <span>1.5</span> -{" "}
              <Trans i18nKey="1.05">
                The User expresses his/her consent to this Personal Data
                Processing Policy when registering with the Service and starting
                to use it.
              </Trans>
            </p>
            ...
            <p className="terms__defenition none">
              <span>1.6</span> -{" "}
              <Trans i18nKey="1.06">
                If the User does not agree with the terms of personal data
                processing, he/she must stop using the Service.
              </Trans>
            </p>
            ...
            <p className="terms__defenition none">
              <Trans i18nKey="consent">
                - consent of the personal data subject (Article 6, paragraph 1,
                item 1 of the Federal Law-152);
              </Trans>
            </p>

            <p className="terms__defenition none">
              <Trans i18nKey="fulfillment">
                - fulfillment of the contract with the user (Art. 6, part 1, p.
                5 of the Federal Law-152);
              </Trans>
            </p>

            <p className="terms__defenition none">
              <Trans i18nKey="fulfillment of obligations">
                - fulfillment of obligations stipulated by Russian legislation
                (e.g., tax accounting).
              </Trans>
            </p>

            <h3 className="terms__subtitle none">2.{t("Data Collected")}</h3>
            ...
            <p className="terms__defenition none">
              <Trans i18nKey="Usage Data">
                - Usage Data: IP address, browser type, operating system, and
            ...
            <p className="terms__defenition none">
              <Trans i18nKey="The service does">
                - The service does not collect biometric data, health
                information, political views, race, nationality and religion.
              </Trans>
            </p>
            ...
            <p className="terms__defenition none">
              ...
              <Trans i18nKey="The Service ensures">
                The Service ensures that third parties comply with data
                protection regulations and handle personal data securely.
              </Trans>
            </p>
            ...
            <p className="terms__defenition none">
              ...
              <Trans i18nKey="The Operator may">
                The Operator may transfer personal data abroad only to countries
                that ensure adequate protection of personal data (Article 12 of
                the Federal Law-152). In case of data transfer to countries that
                are not included in this list, the Operator requests additional
            ...
            <p className="terms__defenition none">
              ...
              <Trans i18nKey="The Service stores">
                The Service stores user data on secure servers with encryption
            ...
            <p className="terms__defenition none">
              ...
              <Trans i18nKey="Personal data is retained">
                ...
                fulfill the purposes outlined in this Policy, after which it is
                securely deleted.
              </Trans>
            </p>
            ...
            <p className="terms__defenition none">
              ...
              <Trans i18nKey="Personal data shall">
                Personal data shall be stored for the period necessary to
                fulfill the specified processing purposes, but no longer than 3
                (three) years after deletion of the account, unless otherwise
            ...
            <p className="terms__defenition none">
              ...
              <Trans i18nKey="After the expiration">
                After the expiration of the said period, personal data shall be
                destroyed or depersonalized.
              </Trans>
            </p>
            ...
            <p className="terms__defenition none">
              <Trans i18nKey="Right to Restrict">
                - Right to Restrict Processing – Limit the use of personal data
            ...
            <p className="terms__defenition none">
              ...
              <Trans i18nKey="The User can disable">
                The User can disable cookies in the browser settings. Disabling
                cookies may affect the performance of some functions of the
                Service.
              </Trans>
            </p>
            ...
            <p className="terms__defenition none">
              ...
              <Trans i18nKey="The Operator notifies">
                The Operator notifies users about the changes made to the
                Personal Data Processing Policy by publishing the updated
            ...
            <p className="terms__defenition none">
              ...
              <Trans i18nKey="In case of material">
                In case of material changes requiring a new consent, the
                Operator will notify the users in an additional way (e.g. via
                email).
              </Trans>
            </p>
