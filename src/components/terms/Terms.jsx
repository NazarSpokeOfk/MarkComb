        ...
        <div className="terms__container">
          ...
          <p className="terms__defenition none">
            ...
            <Trans i18nKey="Contentmaker-defi">
              a person who independently creates and publishes various types of
              content (texts, images, videos, audio files and other materials)
              for the purpose of information dissemination, audience interaction
              or commercial use on various platforms and media environments.
            </Trans>
          </p>
          ...
          <p className="terms__defenition none">
            ...
            <Trans i18nKey="Contact-defi">
              is publicly available information collected and made available to
              users through the technologies of our service. This data includes
              e-mail addresses, links to social networks and other information
              intended for communication with content creators. Our service uses
              technology to find and process such information from public
              sources, while not violating the privacy and rights of third
              parties. Contact information is provided for the purpose of
              interacting with content creators, but the service does not
              guarantee its relevance, completeness or relevance to specific
              user requests
            </Trans>
          </p>
          ...
          <p className="terms__defenition none">
            4.1{" "}
            <Trans i18nKey="4.1">
              Selling accounts, with contentmakers' contact information already
              purchased; <br />
          ...
          <p className="terms__defenition none">
            4.2{" "}
            <Trans i18nKey="4.2">
              Using the service for spam mailings;
            </Trans>
          </p>
          ...
          <p className="terms__defenition none">
            4.4{" "}
            <Trans i18nKey="4.4">
              Resale of previously purchased contact data to other service users
            </Trans>
          </p>
          ...
          <p className="terms__defenition none">
            ...
            trying to find a password to an existing account, which does not belong to you 
            </Trans>
          </p>
          ...
          <p className="terms__defenition none">
            5.1{" "}
            <Trans i18nKey="5.1">
            Purchase of “Uses” is made through payment systems connected to the service.            
            </Trans>
          </p>
          ...
          <p className="terms__defenition none">
            5.2{" "}
            <Trans i18nKey="5.2">
            There are no refunds, except in cases of technical errors on the part of the service         
            </Trans>
          </p>

          <h3 className="terms__subtitle none">6. {t("Limitations of liability")}</h3>

          <p className="terms__defenition none">
            6.1{" "}
            <Trans i18nKey="6.1">
            The service provides data “as is” and is not responsible for its accuracy.    
            </Trans>
          </p>
          ...
          <p className="terms__defenition none">
            6.2{" "}
            <Trans i18nKey="6.2">
            Administration is not responsible for losses caused by the use of the service or impossibility to use the service    
            </Trans>
          </p>
          ...
          <p className="terms__defenition none">
            6.3{" "}
            <Trans i18nKey="Contact-defi">
            The Service is not responsible for any damages resulting from unauthorized access to user accounts.
            </Trans>
          </p>
          ...
          <p className="terms__defenition none">
            7.1{" "}
            <Trans i18nKey="7.1">
            Service using personal data in accordance with policy of <Link to={"/dataprocessing"}>personal data processing</Link>
            </Trans>
          </p>
          ...
          <p className="terms__defenition none">
            8.1{" "}
            <Trans i18nKey="8.1">
            The Service reserves the right to change the terms and conditions without prior notice
            </Trans>
          </p>  
          ...
          <p className="terms__defenition none">
            8.2{" "}
            <Trans i18nKey="8.2">
            Continued use of the service after the changes means agreement to the new terms and conditions.
            </Trans>
          </p>  
          ...
          <h3 className="terms__subtitle none">9. {t("Dispute Resolution")}</h3>  

          <p className="terms__defenition none">
            9.1{" "}
            <Trans i18nKey="9.1">
            All disputes shall be settled in a pre-trial procedure through negotiations.
            </Trans>
          </p>  
          ...
          <p className="terms__defenition none">
            9.2{" "}
            <Trans i18nKey="9.2">
            If no agreement can be reached, the dispute is considered in court at the place of registration of the service owner.
            </Trans>
          </p>  
        </div>
      </section>
