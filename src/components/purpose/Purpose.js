...
const Purpose = () => {
  ...
  return (
    <>
      ...
      <section class="terms">
        <h1 class="terms__title">{t("Our purpose")}</h1>
        <div class="terms__container">
        <h3 class="terms__subtitle none"><Trans i18nKey="purpose-title">
        Our purpose is to provide data for     
        the people who need it. 
            </Trans> </h3>
          <h3 class="terms__subtitle none"><Trans i18nKey="first-question">
          ...
          <h3 class="terms__subtitle none"><Trans i18nKey="second-question">
          ...
          <h3 class="terms__subtitle none"><Trans i18nKey="Third-question">
          ...
          <h3 class="terms__subtitle none"><Trans i18nKey="Fourth-question">
